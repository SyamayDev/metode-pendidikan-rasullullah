const quizData = [
  {
    question: "Dalam Islam gerhana matahari disebut…",
    answer: "Al-Kusuf",
  },
  {
    question: "Dalam Islam gerhana bulan disebut…",
    answer: "Al-Khusuf",
  },
  {
    question: "Hukum shalat gerhana matahari dan bulan adalah…",
    answer: "Sunnah",
  },
  {
    question: "Jumlah rakaat shalat gerhana adalah … rakaat",
    answer: "2 Rakaat",
  },
  {
    question:
      "Mengingat Kekuasaan Allah merupakan salah satu … shalat gerhana.",
    answer: "Hikmah",
  },
];
...
document.addEventListener("DOMContentLoaded", function () {
  if (window.QuizCommon && typeof window.QuizCommon.renderQuiz === "function") {
    ...
    console.error("QuizCommon not loaded for visual_b_quiz.js");
  }
});
